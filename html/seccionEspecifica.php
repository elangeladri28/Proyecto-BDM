...
<body>
    ...
    $seccionInfo = $seccionObj->showSeccionById($_GET['idShowSeccion']);
    $nombreSeccion = $seccionInfo[0]['categoryName'];
    $colorSeccion = $seccionInfo[0]['categoryColor'];
    ?>
    <div class="container" style="background-color:<?php echo $colorSeccion?>">
        <div class="container">
            <h1 style="color:white"><?php echo $nombreSeccion; ?></h1>
            <div class="row clearfix">
                <?php
                    $noticiasPorSeccionObj = new NoticiasView;
                    $noticiasPorSeccionList = $noticiasPorSeccionObj->showNoticiasPorSeccion($_GET['idShowSeccion']);
